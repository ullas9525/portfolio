...
export const projects = [
  {
    ...
    image: asset('projects/intellithreat.png'),
  ...
  },
  {
    ...
    image: asset('projects/navigation.png'),
    ...
    contribution: 'Team contribution — I developed the LLM / AI integration (Gemini vision blueprint extraction pipeline).',
  ...
  },
  {
    id: 'dictation',
    name: 'Dictation App',
    image: asset('projects/dictation.png'),
  ...
  },
  {
    id: 'pilldoze',
    name: 'PillDoze',
    image: asset('projects/pilldoze.png'),
    ...
    contribution: 'Team contribution — I built the IoT circuit (Arduino, sensor wiring and detection logic).',
  ...
  },
  {
    id: 'careerpilot',
    name: 'Career-Pilot',
    image: asset('projects/careerpilot.png'),
